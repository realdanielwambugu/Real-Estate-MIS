...
<body>
    <main style='background-image:url("<?= basePath() ?>/public/assets/images/bg/bg2.jpg")'
    class="w-full ff-pri bgColor-1 h-auto lg:h-screen py-10 bg-no-repeat bg-cover">
        <form id="signin" action="signin" method="post"
        class="w-11/12 lg:w-5/12 m-0-auto py-10 shadow-around bgColor-1-300">
